...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\arogers\PycharmProjects\FlaskTaskCards\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\arogers\PycharmProjects\FlaskTaskCards\venv\Scripts\deactivate.nu'
